...
Expr* Expr::makeBoolUnary(OperatorType op, Expr* expr) {
	Expr* e = new Expr(kExprBoolean);
	e->op_type = op;
	e->expr = expr;
	e->expr2 = NULL;
	return e;
...
Expr* Expr::makeBoolBinary(Expr* expr1, OperatorType op, Expr* expr2) {
	Expr* e = new Expr(kExprBoolean);
	e->op_type = op;
	e->expr = expr1;
	e->expr2 = expr2;
...
Expr* Expr::makeBoolBinary(Expr* expr1, OperatorType op, std::vector<Expr*>* list) {
	Expr* e = new Expr(kExprBoolean);
	e->op_type = op;
	e->expr = expr1;
	e->expr2 = NULL;
...
Expr* Expr::makeCalculate(Expr* expr, OperatorType op) {
	Expr* e = new Expr(kExprCalculate);
	e->op_type = op;
	e->expr = expr;
	e->expr2 = NULL;
	return e;
